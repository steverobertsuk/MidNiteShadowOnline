---
title: 'Combat Encounter Director v1.0.1'
summary: 'Version 1.0.1 updates the primary command for the Combat Encounter Director to prevent conflicts with other Roll20 API scripts.'
date: 2026-06-15
